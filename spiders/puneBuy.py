...
class PuneSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=CITY_URLS&cityName=Pune&cityId=21&templateId=MAKAAN_CITY_LISTING_BUY&page=%s' % page for page in xrange(1,6)]
